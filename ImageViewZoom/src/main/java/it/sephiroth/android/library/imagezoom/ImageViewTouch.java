...
public class ImageViewTouch extends ImageViewTouchBase {
    ...
    protected boolean mDoubleTapScaleEnabled = false;
    ...
    public void setDoubleTapScaleEnabled(boolean value) {
        mDoubleTapScaleEnabled = value;
    }
...
//			return false;
    ...
    public class GestureListener extends
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if (mTapListener != null) {
                boolean ret = mTapListener.onImageSingleTapUp(e);
                if (ret) {
                    return true;
                }
            }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mTapListener != null) {
                boolean ret = mTapListener.onImageSingleTapUpConfirm(e);
                if (ret) {
                    return true;
                }
            }
